...
// middleware
// 'https://sprightly-beignet-1d1056.netlify.app',
app.use(cors({
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.na448cw.mongodb.net/?retryWrites=true&w=majority`;
